...
switch controller_type
    case 1
        save(['_data\simulation_data\DeeP_LCC\constrained_simulation\simulation_data10',data_str,'_',num2str(i_data),'_perType_',num2str(per_type),'_noiseLevel_',num2str(acel_noise),...
