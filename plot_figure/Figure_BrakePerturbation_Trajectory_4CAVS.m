...
switch controller_type
    case 1
            load(['_data\simulation_data\Decentralized_DeeP_LCC\Brake_Simulation_Decentralized.mat']);
            controller_str = 'DeeP-LCC';
%                 load(['_data\Paper_Data\QP_DeeP\Brake_Simulation_Decentralized_Fix.mat']);
%                 controller_str = 'DeeP-LCC';
    case 2
...
for i = 1:n_vehicle
    if ID(i) == 1
        ...
        elseif id_cav == 3
            ...
            id_cav  = id_cav+1;
        elseif id_cav == 4
            plot(begin_time:Tstep:end_time,S(begin_time/Tstep:end_time/Tstep,i+1,2),'Color',color_green,'linewidth',line_width); hold on;
        end
    end 
end
grid on;
...
for i = 1:n_vehicle
    if ID(i) == 1
        ...
        elseif id_cav == 3
            ...
            id_cav  = id_cav+1;
        elseif id_cav == 4
            plot(begin_time:Tstep:end_time,S(begin_time/Tstep:end_time/Tstep,i+1,3),'Color',color_green,'linewidth',line_width); hold on; % line for velocity of CAVs
        end
    end 
end
grid on;
