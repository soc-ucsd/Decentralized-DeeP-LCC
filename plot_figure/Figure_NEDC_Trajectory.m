...
if mix
    switch controller_type
        case 1
            load(['_data\simulation_data\Decentralized_DeeP_LCC\NEDC_Simulation_Decentralized.mat']);
...
for i = 1:n_vehicle
    if ID(i) == 1
        ...
        elseif id_cav == 2
            ...
            id_cav = id_cav+1;
        elseif id_cav == 3
            plot(time_scale,S(begin_time/Tstep:round(total_time/Tstep),i+1,2),'Color',color_orange,'linewidth',line_width); hold on; % line for velocity of CAVs
            id_cav  = id_cav+1;
        elseif id_cav == 4
            plot(time_scale,S(begin_time/Tstep:round(total_time/Tstep),i+1,2),'Color',color_green,'linewidth',line_width); hold on; % line for velocity of CAVs
        end
    end
end
