...
function [uout, problem_status] = rb_DeeP_LCC_Prop2(UP,YP,UF,YF,WP,WF,...
...
%     K = ones(m2*N, 1);
    ...
    controller2  = optimizer([Uc,Wc],objective1,[],{xini1, ml1, mp1, ml2, mp2},u1);
    [uout, problem_status] = controller2(Xini, Ml1, Mp1, Ml2, Mp2);
else
    [uout, problem_status] = controller2(Xini, Ml1, Mp1, Ml2, Mp2);
