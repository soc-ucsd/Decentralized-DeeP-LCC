...
function [uout, problem_status] = rb_DeeP_LCC_Prop4(UP,YP,UF,YF,WP,WF,...
...
%     K = ones(m2*N, 1);
    ...
    controller4  = optimizer([Uc,Wc],objective1,[],{xini1, ml1, mp1, ml2, mp2},u1);
    [uout, problem_status] = controller4(Xini, Ml1, Mp1, Ml2, Mp2);
else
    [uout, problem_status] = controller4(Xini, Ml1, Mp1, Ml2, Mp2);
