...
function [uout, problem_status] = rb_DeeP_LCC_Bound3(UP,YP,UF,YF,WP,WF,...
...
%     K = ones(m2*N, 1);
    ...
    controller3  = optimizer([Uc,Wc],objective1,[],{xini1, ml, mp},u1);
    [uout, problem_status] = controller3(Xini, Ml, Mp);
else
    [uout, problem_status] = controller3(Xini, Ml, Mp);
end
