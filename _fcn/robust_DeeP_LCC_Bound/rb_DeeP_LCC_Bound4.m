...
function [uout, problem_status] = rb_DeeP_LCC_Bound4(UP,YP,UF,YF,WP,WF,...
...
%     K = ones(m2*N, 1);
    ...
    controller4  = optimizer([Uc,Wc],objective1,[],{xini1, ml, mp},u1);
    [uout, problem_status] = controller4(Xini, Ml, Mp);
else
    [uout, problem_status] = controller4(Xini, Ml, Mp);
end
