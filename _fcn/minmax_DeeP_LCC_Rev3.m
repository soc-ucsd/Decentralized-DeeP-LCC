...
function [uout, problem_status] = minmax_DeeP_LCC_Rev3(UP,YP,UF,YF,WP,WF,...
...
%     K = ones(m2*N, 1);
    ...
    controller3  = optimizer([Uc,Wc],objective1,[],{xini1},u1);
    [uout, problem_status] = controller3(Xini);
else
    [uout, problem_status] = controller3(Xini);
end
