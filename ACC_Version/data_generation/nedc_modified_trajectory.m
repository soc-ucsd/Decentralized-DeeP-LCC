...
% 
% Tstep          = 0.05;
% total_time     = 10+8+40+13+40+25+40+10+40;
...
%    elseif i*Tstep <= 10+8+40
%        vel(i) = 50;
%    elseif i*Tstep <= 10+8+40+13
%        vel(i) = 50 + 20/13*(i*Tstep-(10+8+40));
%    elseif i*Tstep <= 10+8+40+13+40
%        vel(i) = 70;
%    elseif i*Tstep <= 10+8+40+13+40+25
%        vel(i) = 70 + 30/25*(i*Tstep-(10+8+40+13+40));
%    elseif i*Tstep <= 10+8+40+13+40+25+40
%        vel(i) = 100; 
%    elseif i*Tstep <= 10+8+40+13+40+25+40+10
%        vel(i) = 100 - 30/10*(i*Tstep-(10+8+40+13+40+25+40));
%    elseif i*Tstep <= 10+8+40+13+40+25+40+10+40
%        vel(i) = 70;
%    end
% end
% plot(vel);
