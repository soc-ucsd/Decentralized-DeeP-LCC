    ...
    if mix
        ...
        switch controller_type
            ...
            case 3 %dDeeP-LCC(Constant)
                ...
                [u_tempt, pr_tempt, time_comp_tempt] = DeeP_LCC_Const_Vertex_Test(Uip{i},Yip{i},Uif{i},Yif{i},Eip{i},Eif{i},...
                                                                         ui_ini{i},yi_ini{i},ei_ini{i},weight_v, weight_s, weight_u,...
                                                                         lambda_g,lambda_y,u_limit,s_limit);
                [u_tempt1, pr_tempt1, time_comp_tempt1] = DeeP_LCC_Const_Dual_Test(Uip{i},Yip{i},Uif{i},Yif{i},Eip{i},Eif{i},...
                                                                         ui_ini{i},yi_ini{i},ei_ini{i},weight_v, weight_s, weight_u,...
                                                                         lambda_g,lambda_y,u_limit,s_limit);
                time_temp1 = max(time_comp);
                time_all(k-Tini+1) = time_temp1;
