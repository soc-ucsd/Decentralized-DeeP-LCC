...
switch hdv_type
    case 1
        % Driver Model: OVM
        load(['_data/hdv_ovm4CAVS_',num2str(data_str),'.mat']);
    case 2
        % Driver Model: IDM
...
save(['_data\trajectory_data_collection\data_4CAVS_',num2str(data_str),'_',num2str(i_data),'_noiseLevel_',num2str(acel_noise),'.mat'],...
