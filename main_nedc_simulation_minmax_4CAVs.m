...
head_vehicle_trajectory     = load('_data/nedc_modified_v3.mat');
    ...
    if mix
        switch controller_type
            case 1  % calculate control input via DeeP-LCC     
                if constraint_bool
                    [u_opt, pr] = minmax_DeeP_LCC_Rev1(Up,Yp,Uf,Yf,Ep,Ef,uini,yini,eini,weight_v, weight_s, weight_u, r(:,k:k+N-1),...
...
switch controller_type
    case 1    
%         save(['_data\simulation_data\DeeP_LCC\nedc_simulation\simulation_dataTest5',data_str,'_',num2str(i_data),'_modified_v',num2str(trajectory_id),'_noiseLevel_',num2str(acel_noise),...
...
%             'hdv_type','acel_noise','S','T','Tini','N','ID','Tstep','v_star','pr_status');
          save(['_data\simulation_data\Decentralized_DeeP_LCC\NEDC_Simulation_Centralized.mat'],...
            'hdv_type','acel_noise','S','T','Tini','N','ID','Tstep','v_star','pr_status');
    case 2
